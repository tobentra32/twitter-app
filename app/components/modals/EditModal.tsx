...
const EditModal = () => {
  ...
  const bodyContent = (
    <div className="flex flex-col gap-4">
      <ImageUploads value={profileImage} disabled={isLoading} onChange={(image) => setProfileImage(image)} label="Upload profile image" />
      <ImageUploads value={coverImage} disabled={isLoading} onChange={(image) => setCoverImage(image)} label="Upload cover image" />
      <Input
        placeholder="Name"
